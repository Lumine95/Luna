package com.mm.luna.view.statusLayoutView;
...
public class StatusLayoutManager {
    ...
    private void createLoadingLayout() {
        ...
        ImageView ivLoading = loadingLayout.findViewById(R.id.iv_loading);
        ...
        if (!TextUtils.isEmpty(loadingText)) {
            ...
            loadingTextView = loadingLayout.findViewById(R.id.tv_status_loading_content);
